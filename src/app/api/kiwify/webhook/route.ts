    ...
    return [
      ...
      },
      {
        ...
        metadata: {
          ...
          button_payload: "ja_assisti_boas_vindas",
          button_text: "Já assisti ▶",
        },
        mensagem:
          `${nome}, seja bem-vinda ao ${productName}.\n\n` +
          "Assista ao video de boas-vindas do criador e idealizador do TRINCA RV21, Ruria Virginio. Quando terminar, toque em Ja assisti.",
      },
      {
        ...base,
        ...
        metadata: {
          ...
          sequence_order: 2.1,
          gate: true,
          expected_button_payload: "ja_assisti_boas_vindas",
          unlocks_step: "materiais-desafio",
        },
        mensagem: "Gate interno: clique em Ja assisti apos o video de boas-vindas.",
      },
      {
        ...base,
        ...
        metadata: {
          ...
          sequence: "pos-compra",
          sequence_order: 3,
          required_previous_steps: ["clique-boas-vindas-assistido"],
          body_variable_order: [],
          ...
          button_payload: "recebi_materiais",
          button_text: "Recebi, continuar ▶",
        },
        mensagem:
          ...
          "Guarde esses materiais. Quando estiver pronta, toque em Recebi.",
      },
      {
        ...base,
        ...
        metadata: {
          ...
          sequence_order: 3.1,
          gate: true,
          expected_button_payload: "recebi_materiais",
          unlocks_step: "grupo-oficial-preparacao",
        },
        mensagem: "Gate interno: clique em Recebi apos os materiais.",
      },
      {
        ...base,
        ...
        metadata: {
          ...
          sequence: "pos-compra",
          sequence_order: 4,
          required_previous_steps: ["clique-materiais-recebido"],
      ...
      },
      {
        ...
        metadata: {
          ...
          button_payload: "quero_link_grupo",
          button_text: "Quero o link ▶",
        },
        mensagem:
          `${nome}, assista ao video oficial de boas-vindas ao Grupo Oficial TRINCA RV21. Quando terminar, toque em Quero o link.`,
      },
      {
        ...base,
        ...
        metadata: {
          ...
          sequence_order: 5.1,
          gate: true,
          expected_button_payload: "quero_link_grupo",
          unlocks_step: "grupo-oficial-link",
        },
        mensagem: "Gate interno: clique em Quero o link apos o video do grupo.",
      },
      {
        ...base,
        ...
        metadata: {
          ...
          sequence_order: 6,
          send_as_text: true,
          required_previous_steps: ["clique-grupo-quero-link"],
          delay_after_previous_minutes: 0,
          body_variable_order: [],
        },
        mensagem:
