# Mensagens de recuperacao TRINCA RV21

## Principio

O tom deve ser persistente sem parecer invasivo: acolhe, lembra a decisao inicial, reforca o beneficio e abre uma acao simples. Cada mensagem precisa ter uma chamada clara.

## Abandono apos formulario
...
Talvez essa seja exatamente a hora de parar de adiar voce.

O TRINCA RV21 nao e sobre perfeicao. E sobre entrar em movimento com estrutura, suporte e compromisso por 21 dias.

Se voce ainda quer participar, finalize sua entrada aqui: [link_checkout]
...
Sua vaga no TRINCA RV21 ainda nao foi confirmada.
...
Parabens por concluir o TRINCA RV21.

Agora voce desbloqueou o cupom `TRINCA PREMIUM50%` para continuar sua evolucao na Plataforma RV ONLINE.

Usar cupom: [link_plataforma]
